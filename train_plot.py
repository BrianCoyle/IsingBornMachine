...
from mmd_functions import MMDKernel, MMDGrad, MMDCost
...
def Plot(N, N_v, N_epochs, initial_params, \
    ...
    L_stein, L_var, L_mmd, circuit_params, born_probs_list, empirical_probs_dict = TrainBorn(N, N_v, cost_func,\
                                                                            initial_params, \
    ...
    plt.xlabel("Epochs")
    plt.ylabel("Loss")
    plt.title("Loss for %i qubits" % N_v)

    return L_stein, L_var, L_mmd , circuit_params, born_probs_list, empirical_probs_dict
