...
def compute_amp_term(N, N_v, N_h, J, b, gamma, p, q, r, bin_visible, bin_hidden, control):
	...
	for v_string in range(0, 2**N_v):
		for h_string in range(0, 2**N_h):
			...
			Amp1[v_string, h_string] =  amp.Amplitude_Computation1(N, N_v, N_h, J, b, gamma,\
			 											bin_visible[v_string,:], bin_hidden[h_string,:])

			Amp2[v_string, h_string] =  amp.Amplitude_Computation2(N, N_v, N_h, J, b, gamma, \
											p, q, r,  bin_visible[v_string, :], bin_hidden[h_string, :], control)
