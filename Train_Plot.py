...
KL1, P_v1, J, b, gamma =  train(N1, N_h1, N_v1, N_epochs, data1, bin_visible1, bin_hidden1)
...
KL2, P_v2, J, b, gamma =  train(N2, N_h2, N_v2, N_epochs, data1, bin_visible2, bin_hidden2)

sys.stdout = open('%iNv_%iNepochs' % (N_v1,N_epochs), 'a')
...
plt.legend()
plt.savefig("%iN_%iNv_%iNh_%iN_%iNv_%iNh.png" %(N1, N_v1, N_h1, N2, N_v2, N_h2))
#To Do
