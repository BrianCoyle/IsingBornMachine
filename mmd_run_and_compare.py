...
plt.savefig("MMD_%iNv_%s_%s_%.4fLR_%s_%s_%.4fLR_%iEpochs.pdf" \
    %(N_v1, kernel_type1[0], approx1[0], learning_rate1,kernel_type2[0], approx2[0], learning_rate2,  N_epochs))
...
sys.stdout = open("Output_MMD_%iNv_%s_%s_%.3fLR_%s_%s_%.3fLR_%iEpochs" \
    %(N_v1, kernel_type1[0], approx1 ,learning_rate1,kernel_type2[0], approx2[0], learning_rate2, N_epochs), 'w')
